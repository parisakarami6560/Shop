...
namespace shop {
    ...
    public partial class shopDataSet1 : global::System.Data.DataSet {
        ...
        public partial class productDataTable : global::System.Data.TypedTableBase<productRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public productRow AddproductRow(int code_product, string name_product, string brand, string kind) {
...
namespace shop.shopDataSet1TableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[product] ([code_product], [name_product], [brand], [kind]) VAL" +
                "UES (@code_product, @name_product, @brand, @kind);\r\nSELECT code_product, name_pr" +
                "oduct, brand, kind FROM product WHERE (code_product = @code_product)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[product] SET [code_product] = @code_product, [name_product] = @name_product, [brand] = @brand, [kind] = @kind WHERE (([code_product] = @Original_code_product) AND ((@IsNull_name_product = 1 AND [name_product] IS NULL) OR ([name_product] = @Original_name_product)) AND ((@IsNull_brand = 1 AND [brand] IS NULL) OR ([brand] = @Original_brand)) AND ((@IsNull_kind = 1 AND [kind] IS NULL) OR ([kind] = @Original_kind)));
SELECT code_product, name_product, brand, kind FROM product WHERE (code_product = @code_product)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT code_product, name_product, brand, kind FROM dbo.product";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT code_product, name_product, brand, kind FROM dbo.product where code_produc" +
                "t=@code";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@code", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "code_product", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[product] ([code_product], [name_product], [brand], [kind]) VAL" +
                "UES (@code_product, @name_product, @brand, @kind);\r\n";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@brand", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "brand", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@kind", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "kind", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(shopDataSet1.productDataTable dataTable, int code) {
        ...
        public virtual shopDataSet1.productDataTable GetDataBy(int code) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(code));
            shopDataSet1.productDataTable dataTable = new shopDataSet1.productDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual int Delete(int Original_code_product, string Original_name_product, string Original_brand, string Original_kind) {
        ...
        public virtual int Insert(int code_product, string name_product, string brand, string kind) {
        ...
        public virtual int Update(int code_product, string name_product, string brand, string kind, int Original_code_product, string Original_name_product, string Original_brand, string Original_kind) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_code_product));
            if ((Original_name_product == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name_product, string brand, string kind, int Original_code_product, string Original_name_product, string Original_brand, string Original_kind) {
            return this.Update(Original_code_product, name_product, brand, kind, Original_code_product, Original_name_product, Original_brand, Original_kind);
        }
        ...
        public virtual int InsertQuery(int code_product, string name_product, string brand, string kind) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            command.Parameters[0].Value = ((int)(code_product));
            if ((name_product == null)) {
